                ...
                <div class="col-md-10">
                    ...
                    <table style="width:100%">
                        ...
                        <?php 
                            ...
                            $result = mysqli_query($db,"SELECT * FROM siswa ORDER BY kelas,nisn");
                            $total = mysqli_num_rows($result);
                            $pages = ceil($total/$halaman);            
                            $query = mysqli_query($db,"SELECT * FROM siswa LIMIT $mulai, $halaman")or die(mysql_error);
                            $no =$mulai+1;
                            $i = $no;
                            ...
                            <td><?= $siswa['alamat']; ?></td>
                            <td><a href="DetailSiswa2.php?kode=<?= $NISN ?>">
                                    <div class="btn btn-success w90 box-shadow">Profile</div></a></td>
                            <td><a href="EditSiswa.php?kode=<?= $NISN ?>">
                                    <div class="btn btn-warning w90 box-shadow">Edit</div></a></td>
                            <td><a href="AllProcess.php?action=HapusSiswa&kode=<?= $NISN ?>">
                    ...
                    <div class="col-md-8" style="margin: 40px 0px 30px 0px;display:flex">
                        <?php for($i=1; $i<=$pages ; $i++){ ?>
                            <a href="AllSiswa.php?halaman=<?php echo $i; ?>">
                                <div class="btn btn-info w90 col-md-1"><?php echo $i; ?>
                                </div>
                            </a>
                        <?php } ?>

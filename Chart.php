<?php 
    ...
    $kode = $_GET['kelas'];
    $kelas = decrypt($kode);
    $jlh_siswa = GetJumlahSiswa($kelas);
    // echo $kode_acara;
    $jlh_hadir = CountKehadiran_byGuru('hadir',$_SESSION['kode_guru'],$kelas);
    $jlh_izin = CountKehadiran_byGuru('izin',$_SESSION['kode_guru'],$kelas);
    $jlh_sakit = CountKehadiran_byGuru('sakit',$_SESSION['kode_guru'],$kelas);
    $jlh_alpha = CountKehadiran_byGuru('alpha',$_SESSION['kode_guru'],$kelas); 

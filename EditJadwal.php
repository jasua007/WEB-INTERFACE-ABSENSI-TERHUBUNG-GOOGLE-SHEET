            ...
            <div class="col-md-12 content box-shadow" style="margin:5px 0px 5px 0px;padding:0px">
                ...
                <div class="col-md-10">
                    ...
                    <?php 
                        ...
                        $id_jadwal = decrypt($kode_jadwal);
                        $jadwal = getJadwal($id_jadwal);
                        
                    ?>
                        <h2>Data Guru</h2>
                        <form method="POST" action="AllProcess.php?action=EditJadwal&kode=<?= $kode_jadwal; ?>">
                            <table class="table-gap" style="width:90%;">
                                <tr>
                                    <td class="td-info"><b>ID Jadwal</b></td>
                                    <td style="max-width:5px;"></td>
                                    <td style="width:80%"><input type="text" name="jadwal" value="<?= $jadwal['id_jadwal']; ?>" required></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="max-width:5px;"></td>
                                    <td style="width:80%"><input type="time" name="jam_mulai" value=<?= $jadwal['jam_mulai'] ?> required></td>
                                </tr>
                                <tr>
                                    <td style="height:8px;"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="max-width:5px;"></td>
                                    <td style="width:80%"><input type="time" name="jam_berakhir" value=<?= $jadwal['jam_berakhir'] ?> required></td>
                                </tr>
                                <tr>
                                    <td style="height:8px;"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="max-width:5px;"></td>
                                    <td style="width:80%"><input type="text" name="kode_guru"  value=<?= $jadwal['kode_guru'] ?> required></td>
                                </tr>
                                <tr>
                                    <td style="height:8px;"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="max-width:5px;"></td>
                                    <td style="width:80%"><input type="text" name="kelas"  value=<?= $jadwal['kelas'] ?> required></td>
                                </tr>
                                <tr>
                                    <td style="height:8px;"></td>
                                </tr>

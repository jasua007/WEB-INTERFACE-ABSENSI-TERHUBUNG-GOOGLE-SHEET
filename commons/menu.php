...
<div class="col-md-2 menu" style="height:100%">
    ...
    <table style="margin-top:10px;">
        ...
        <?php if($_SESSION['role'] == 1){
            echo '<tr>';
            echo '<td class="td_menu" style="text-align:left">';
                echo '<a href="AllAkun.php">Manage Akun</a>';
            echo '</td>';
            echo '</tr>';
            ...
            echo '<tr>';
            echo '<td class="td_menu" style="text-align:left">';
                echo '<a href="AllJadwal.php">Manage Jadwal</a>';
            echo '</td>';
            echo '</tr>';
            }
        ...
        <tr>
            <td class="td_menu" style="text-align:left">

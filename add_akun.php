            ...
            <div class="col-md-12 content box-shadow" style="margin:5px 0px 5px 0px;padding:0px">
                ...
                <div class="col-md-10">
                        <ul class="breadcrumb box-shadow">
                            ...
                            <li><a href="#" style="text-decoration: none;color:white;">Tambah Akun</a></li>
                        </ul>
                         <!-- CONTENTS START HERE -->
                         <a href="AllAkun.php"><div class="btn btn-success" style="margin-bottom:15px;">
                        ...
                        <form method="POST" action="AllProcess.php?action=TambahAkun">
                            <table class="table-gap" style="width:90%;">
                                <tr>
                                    ...
                                    <td style="width:80%"><input type="text" name="username" required></td>
                                </tr>
                                <tr>
                                    <td style="height:8px;"></td>
                                </tr>
                                <tr>
                                    <td class="td-info"><b>Password</b></td>
                                    <td style="max-width:5px;"></td>
                                    <td style="width:80%"><input type="password" name="password" required></td>
                                </tr>
                                <tr>
                                    <td style="height:8px;"></td>
                                </tr>
                                <tr>
                                    <td class="td-info"><b>Re-Type Password</b></td>
                                ...
                                <tr>
                                    <td class="td-info"><b>Pilih Role</b></td>
                                    <td style="width:5px;"></td>
                                    <td>
                                        <select name="role" style="height:40px;width:50%;border-radius:5px" class="box-shadow">

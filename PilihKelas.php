        ...
        <div class="container">
            ...
            <div class="col-md-12 content box-shadow" style="margin:5px 0px 5px 0px;padding:0px">
                ...
                <div class="col-md-10">
                    ...
                    <?php 
                        $angkatan_kelas = encrypt($angkatan_kelas);
                        foreach($angkatan as $data){     
                            ?>
                        <center>
                            <?php
                            $kelas = $data['nama_kelas'];
                            $kelas_encrypt = encrypt($kelas);
                                if($_SESSION['role'] == 2){
                                    echo "<a href='DetailKelas.php?kelas=$kelas_encrypt&angkatan=$angkatan_kelas'>";
                                        echo "<div class='col-md-4 kelas box-shadow bergetar' style='background-color:#1b8cff'>$kelas</div>";
                                    echo "</a>";
                                }
                                else{      
                                    echo "<a href='DetailKelas_admin.php?kelas=$kelas_encrypt&angkatan=$angkatan_kelas'>";
                                        echo "<div class='col-md-4 kelas box-shadow bergetar' style='background-color:#1b8cff'>$kelas</div>";
                                    echo "</a>";
                                }
                            ?>

                    ...
                    ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <table style="width:90%;">
                                ...
                                <br>
                                <?php $username = encrypt($user['username_akun']); ?>
                                <a href="EditAkun.php?kode=<?= $username; ?>">
                                    <div class="btn btn-info"><span class="glyphicon glyphicon-edit">&nbsp</span>Edit Akun</div>
                                </a>
                                <!-- <a href="EditProfil.php?kode=<?= $username; ?>">
                                    <div class="btn btn-warning"><span class="glyphicon glyphicon-user">&nbsp</span>Edit Profil</div>
                                </a> -->
                            </div>
                        </div>
                    </div>

                    ...
                    ?>
                        <h2>Data Guru</h2>
                            <table class="table-gap" style="width:90%;">
                                ...
                                <tr>
                                    <td class="color2"><b>Username Akun</b></td>
                                    <td style="width:5px;"></td>
                                    <td class="color2"><?= $guru['username_akun']; ?></td>
                                </tr>
                                <tr>
                                    <td class="color1"><b>Tempat,Tanggal Lahir</b></td>
                                    <td style="width:5px;"></td>
                                    <td class="color1"><?= $guru['tempat_lahir'].",".$guru['tanggal_lahir']; ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="color1"><b>Alamat</b></td>
                                    <td style="width:10px;"></td>
                                    <td class="color1"><?= $guru['alamat'] ?></td>
                                </tr>
                        </table>
                    </div>
                </div>

                ...
                <div class="col-md-10">
                    ...
                    <table style="width:100%">
                        ...
                        <?php 
                            ...
                            $kode_guru = encrypt($guru['kode_guru']);  
                            ?>
                        <tr>
                           ...
                           <td><a href="DetailGuru.php?kode=<?= $kode_guru ?>">
                                <div class="btn btn-success w90 box-shadow">Profile</div></a></td>
                           <td><a href="EditGuru.php?kode=<?= $kode_guru ?>">
                                <div class="btn btn-warning w90 box-shadow">Edit</div></a></td>
                           <td><a href="AllProcess.php?action=HapusGuru&kode=<?= $kode_guru ?>">
                                <button class="btn btn-danger w90 box-shadow" onclick="return confirm('Apakah Anda Ingin Menghapus Guru Ini?')">Hapus</button>
                                </a>
                           </td>
                        </tr>
                        <?php 

            ...
            <div class="col-md-12 content box-shadow" style="margin:5px 0px 5px 0px;padding:0px">
                ...
                <div class="col-md-10">
                        <ul class="breadcrumb box-shadow">
                            ...
                            <li><a href="AllAkun.php" style="text-decoration: none;color:white;">Semua Akun</a></li>
                    ...
                    ?>
                        <h2>Data Guru</h2>
                        <form method="POST" action="AllProcess.php?action=EditAkun2&kode=<?= $kode_user; ?>">
                            <table class="table-gap" style="width:90%;">
                                <tr>
                                    <td class="td-info"><b>Username</b></td>
                                    <td style="max-width:5px;"></td>
                                    <td style="width:80%"><input type="text" name="old_username" value="<?= $akun['username']; ?>" readonly></td>
                                </tr>
                                <tr>
